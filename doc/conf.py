...
example_gallery_config = {
    ...
    'dont_preprocess': ['../jupyter-notebook/nb_comparison-inversion-cover-crop.ipynb','../jupyter-notebook/nb_paper-cs-vs-fs.ipynb','../jupyter-notebook/nb_paper-noise-height.ipynb','../jupyter-notebook/nb_paper-ert-calibration.ipynb','../jupyter-notebook/nb_paper-river-fdem.ipynb','../jupyter-notebook/nb_multi-frequency.ipynb','../jupyter-notebook/nb_3d-surveys.ipynb'],
    'pattern': 'nb_.+.ipynb',
